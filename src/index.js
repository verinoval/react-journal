...
//
//         if (search && (
//             Journal['searchStyle'] === 'full')) {
//             search.classList.remove('full-search');
//             search.classList.add('mini-search');
//         }
//
//         if (cart && (
//             Journal['cartStyle'] === 'full')) {
...
//         menu: window.matchMedia('(max-width: ' +
//             Journal['mobileMenuOn'] + 'px)')
//     };
//
//     mqr(mqls, function () {
...
//                 style.sheet.insertRule('.module-notification-' +
//                     Journal['notification'][i]['m'] + '{ display:none }');
//             }
//         }
//     }
//
//     if (
//         Journal['headerNotice']) {
//         for (var i in Journal['headerNotice']) {
//             if (cookies['hn-' + Journal['headerNotice'][i]['c']]) {
//                 style.sheet.insertRule('.module-header_notice-' +
//                     Journal['headerNotice'][i]['m'] + '{ display:none }');
//             }
//         }
//     }
//
//     if (
//         Journal['layoutNotice']) {
//         for (var i in Journal['layoutNotice']) {
//             if (cookies['hn-' + Journal['layoutNotice'][i]['c']]) {
//                 style.sheet.insertRule('.module-layout_notice-' +
//                     Journal['layoutNotice'][i]['m'] + '{ display:none }');
//             }
//         }
//     }
// })();